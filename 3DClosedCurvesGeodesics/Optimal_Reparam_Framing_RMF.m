function [z1best,w1best,z2best,w2best,gamIbest] = Optimal_Reparam_Framing_RMF(p1,p2,V2,seeds)
...
for j=1:k
    ...
    V2new = Group_Action_by_Gamma_Coord(V2j,gamI);
    q2new=curve2quat_arbFrame(p2new,V2new);
