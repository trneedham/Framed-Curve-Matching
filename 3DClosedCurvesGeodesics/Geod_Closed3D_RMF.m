function [dist,geod,frames_geod,pushoff_geod,gamI,z1best,z2best,w1best,w2best]=Geod_Closed3D_RMF(p1,p2)
...
% Choose some parameters. These can be adjusted by the user.
    ...
    k=5;   % Number of optimal seeds to take for the initial parameterizations.
...
%     z1best=z1best/norm(z1best);
%     w1best=w1best/norm(w1best);
%     z2best=z2best/norm(z2best);
%     w2best=w2best/norm(w2best);
